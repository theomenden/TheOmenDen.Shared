...
public interface IAccessor<T>
{
    ...
    ValueTask<IEnumerable<T>> GetAllAsync(CancellationToken cancellationToken = new());
    ...
    ValueTask<IEnumerable<T>> GetAllThatMatchAsync(Expression<Func<T, Boolean>> predicate, CancellationToken cancellationToken = new()); 
    ...
    ValueTask<T> WithIdAsync(Guid entityId, CancellationToken cancellationToken = new());
}